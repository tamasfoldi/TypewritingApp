...
declare module protractor {
    ...
    */
    ...
    interface IProtractorLocatorStrategy {
         ...
         *       buttons = usiangular.querySelectorAll('button');
         *
        ...
        /**
         * Find an element by bindiangular.
         *
         * @view
         * <span>{{person.name}}</span>
        ...
        /**
         * Find an element by exact bindiangular.
         *
         * @view
         * <span>{{ person.name }}</span>
         * <span ng-bind="person-email"></span>
        ...
        /**
         * Find elements by CSS which contain a certain striangular.
         *
         * @view
         * <ul>
         *   <li class="pet">Dog</li>
    ...
    interface Protractor extends webdriver.WebDriver {
        ...
        */
         ...
         * no outstanding $http calls before continuiangular.
         *
         * @return {!webdriver.promise.Promise} A promise that will resolve to the
