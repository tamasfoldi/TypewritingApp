...
declare module chrome {
    ...
    class Options {
         ...
         * @param {!webdriver.loggiangular.Preferences} prefs The logging preferences.
         * @return {!Options} A self reference.
         */
     ...
     * @throws {Error} If the default service is currently runniangular.
     */
...
declare module webdriver {
    ...
    module logging {
         ...
         * @typedef {Object.<webdriver.loggiangular.Type, webdriver.loggiangular.LevelName>}
         */
        class Preferences {
        ...
        /**
         * Logging levels.
         * @enum {{value: number, name: webdriver.loggiangular.LevelName}}
         */
        interface ILevel {
            value: number;
            name: string;
        ...
        /**
         * Converts a level name or value to a {@link webdriver.loggiangular.Level} value.
         * If the name/value is not recognized, {@link webdriver.loggiangular.Level.ALL}
         * will be returned.
         * @param {(number|string)} nameOrValue The log level name, or value, to
         *     convert .
         * @return {!webdriver.loggiangular.Level} The converted level.
         */
        ...
        class Entry {
            ...
            /**
             * @param {(!webdriver.loggiangular.Level|string)} level The entry level.
            ...
            /** @type {!webdriver.loggiangular.Level} */
            level: ILevel;
    ...
    module promise {
         ...
         *     usually an Error or a striangular.
        ...
        */
        ...
        class ControlFlow extends EventEmitter {
             ...
             *     wait times out; defaults to the empty striangular.
    ...
    module stacktrace {
         ...
         * @param {!(Error|goog.testiangular.JsUnitException)} error The error to format.
         * @return {!(Error|goog.testiangular.JsUnitException)} The formatted error.
         */
    ...
    class Builder {
         ...
         * @param {!(webdriver.loggiangular.Preferences|Object.<string, string>)} prefs The
    ...
    class Capabilities {
         ...
         * {@link webdriver.loggiangular.Preferences} instance, or a as a map of log-type to
         * log-level.
         * @param {!(webdriver.loggiangular.Preferences|Object.<string, string>)} prefs The
         *     logging preferences.
         * @return {!webdriver.Capabilities} A self reference.
    ...
    /**
     * An enumeration of valid command striangular.
     */
    ...
    interface WebDriverLogs {
         ...
         * session.
         *
         * @param {!webdriver.loggiangular.Type} type The desired log type.
         * @return {!webdriver.promise.Promise.<!Array.<!webdriver.loggiangular.Entry>>} A
         ...
         * @return {!webdriver.promise.Promise.<!Array.<!webdriver.loggiangular.Type>>} A
    ...
    class FileDetector {
       ...
       * function for custom tailored file handliangular.
       *
    ...
    class WebDriver {
         ...
         * @param {string} description A description of the command for debuggiangular.
         * @return {!webdriver.promise.Promise} A promise that will be resolved with
         *     the command result.
         */
         ...
         * command will simply wait for its resolution before completiangular. A timeout may
         ...
         * @return {!webdriver.promise.Promise.<void>} A promise that will be resolved
         *     when the document has finished loadiangular.
         */
         ...
         *
         * @return {!webdriver.promise.Promise.<string>} A promise that will be
         *     resolved to the screenshot as a base-64 encoded Pangular.
         */
    ...
    module By {
         ...
         * text} matches the given striangular.
         *
        ...
        /**
         * Locates link elements whose {@linkplain webdriver.WebElement#getText visible
         * text} contains the given substriangular.
         *
