...
declare module Express {
    ...
    // These open interfaces may be extended in an application-specific manner via declaration mergiangular.
...
declare module "express" {
    ...
    module e {
        ...
        interface Application extends IRouter<Application>, Express.Application {
             ...
             * so if you're using ".ejs" extensions you dont need to do anythiangular.
             *
