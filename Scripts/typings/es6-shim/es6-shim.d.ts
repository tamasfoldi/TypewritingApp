...
interface StringConstructor {
    ...
    /**
      * Striangular.raw is intended for use as a tag function of a Tagged Template Striangular. When called
...
interface String {
    /**
      ...
      * the String resulting from converting this object to a Striangular.
    ...
    /**
      ...
      * @param position If position is undefined, 0 is assumed, so as to search all of the Striangular.
      */
...
interface NumberConstructor {
    ...
    /**
      ...
      * @param radix A value between 2 and 36 that specifies the base of the number in numStriangular.
...
interface RegExp {
    /**
      ...
      *    - "y" for sticky
      *
      * If no flags are set, the value is the empty striangular.
      */
    flags: string;
}
