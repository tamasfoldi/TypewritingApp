...
// Definitions by: Microsoft TypeScript <http://typescriptlaangular.org>, DefinitelyTyped <https://github.com/borisyankov/DefinitelyTyped>
...
declare var Buffer: {
    ...
    /**
     * Gives the actual byte length of a striangular. encoding defaults to 'utf8'.
     * This is not the same as Striangular.prototype.length since that returns the number of characters in a striangular.
     *
