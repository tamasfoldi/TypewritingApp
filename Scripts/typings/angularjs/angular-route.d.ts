...
declare module angular.route {
    ...
    interface IRouteService {
        ...
        // to a controller that was not initialized as a result of a route machiangular.
    ...
    interface IRoute {
        /**
         * {(string|function()=}
         * Controller fn that should be associated with newly created scope or the name of a registered controller if passed as a striangular.
         */
